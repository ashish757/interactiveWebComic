...
function DialoguePop({ id, children, layout, timeline, enterFrom = 'pop', exitTo = 'pop' }: DialoguePopProps) {
    ...
    return (
        <div className="absolute z-30" style={layout}>
            <motion.div
